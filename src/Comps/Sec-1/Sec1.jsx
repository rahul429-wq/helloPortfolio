  ...
  return (
    <section id="sec-1">
      <div className="left">
        ...
        <p>
          Myself Bhavik Prajapati. I am a Web Developer.I Have Knowledge of
          Mern, And I'm Interested to be Mern Stack Dev.
        </p>
        <a
          target="_blank"
          className="my-btn"
          href="https://drive.google.com/file/d/16AkffOV1mn4m1DgXXrbzV6mX9-s-RKvt/view?usp=sharing"
        >
          Resume
        </a>
      </div>
